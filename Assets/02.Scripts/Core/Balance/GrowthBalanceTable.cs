        ...
        private static TrainingProgramDefinition[] CreateDefaultPrograms()
        {
            return new[]
            {
                ...
                new TrainingProgramDefinition("japan_batting_camp", OffseasonActivityType.Study, TrainingCategory.StudyTechnical, PlayerType.Batter,
                    6, MoneyAmount.FromTenThousandWon(3_200L), 2.4d, new[] { new AbilityWeight(PlayerAbility.Contact, 0.55d), new AbilityWeight(PlayerAbility.BatterMental, 0.25d), new AbilityWeight(PlayerAbility.Defense, 0.20d) }, 40, 0.02d, 4, 4, -20, 1, canRaisePotential: true),
                new TrainingProgramDefinition("japan_pitch_design", OffseasonActivityType.Study, TrainingCategory.StudyTechnical, PlayerType.Pitcher,
                    6, MoneyAmount.FromTenThousandWon(3_200L), 2.4d, new[] { new AbilityWeight(PlayerAbility.Breaking, 0.6d), new AbilityWeight(PlayerAbility.Control, 0.4d) }, 40, 0.02d, 4, 4, -20, 1, canRaisePotential: true),
                new TrainingProgramDefinition("usa_power_center", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Batter,
                    8, MoneyAmount.FromTenThousandWon(4_500L), 3.0d, new[] { new AbilityWeight(PlayerAbility.Power, 0.7d), new AbilityWeight(PlayerAbility.Speed, 0.3d) }, 40, 0.03d, 5, 5, -25, 1, canRaisePotential: true),
                new TrainingProgramDefinition("usa_velocity_center", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Pitcher,
                    8, MoneyAmount.FromTenThousandWon(4_500L), 3.0d, new[] { new AbilityWeight(PlayerAbility.Velocity, 0.6d), new AbilityWeight(PlayerAbility.Stamina, 0.4d) }, 40, 0.03d, 5, 5, -25, 1, canRaisePotential: true),
                ...
                new TrainingProgramDefinition("usa_elite_batting_academy", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Batter,
                    9, MoneyAmount.FromTenThousandWon(7_200L), 3.8d, new[] { new AbilityWeight(PlayerAbility.Power, 0.45d), new AbilityWeight(PlayerAbility.Contact, 0.35d), new AbilityWeight(PlayerAbility.BatterMental, 0.20d) }, 55, 0.04d, 6, 5, -28, 2, canRaisePotential: true),
                new TrainingProgramDefinition("usa_elite_pitching_academy", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Pitcher,
                    9, MoneyAmount.FromTenThousandWon(7_200L), 3.8d, new[] { new AbilityWeight(PlayerAbility.Velocity, 0.40d), new AbilityWeight(PlayerAbility.Stuff, 0.35d), new AbilityWeight(PlayerAbility.Control, 0.25d) }, 55, 0.04d, 6, 5, -28, 2, canRaisePotential: true),
                new TrainingProgramDefinition("caribbean_batting_league", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Batter,
                    7, MoneyAmount.FromTenThousandWon(3_800L), 2.7d, new[] { new AbilityWeight(PlayerAbility.Power, 0.45d), new AbilityWeight(PlayerAbility.BatterMental, 0.30d), new AbilityWeight(PlayerAbility.Contact, 0.25d) }, 40, 0.025d, 5, 4, -22, 1, canRaisePotential: true),
                new TrainingProgramDefinition("europe_batting_balance", OffseasonActivityType.Study, TrainingCategory.StudyTechnical, PlayerType.Batter,
                    5, MoneyAmount.FromTenThousandWon(2_500L), 1.9d, new[] { new AbilityWeight(PlayerAbility.Contact, 0.40d), new AbilityWeight(PlayerAbility.Defense, 0.35d), new AbilityWeight(PlayerAbility.BatterMental, 0.25d) }, 40, 0.015d, 3, 3, -16, 1, canRaisePotential: true),
                new TrainingProgramDefinition("caribbean_pitch_league", OffseasonActivityType.Study, TrainingCategory.StudyPhysical, PlayerType.Pitcher,
                    7, MoneyAmount.FromTenThousandWon(3_800L), 2.7d, new[] { new AbilityWeight(PlayerAbility.Stuff, 0.45d), new AbilityWeight(PlayerAbility.PitcherMental, 0.30d), new AbilityWeight(PlayerAbility.Stamina, 0.25d) }, 40, 0.025d, 5, 4, -22, 1, canRaisePotential: true),
                new TrainingProgramDefinition("europe_pitch_balance", OffseasonActivityType.Study, TrainingCategory.StudyTechnical, PlayerType.Pitcher,
                    5, MoneyAmount.FromTenThousandWon(2_500L), 1.9d, new[] { new AbilityWeight(PlayerAbility.Control, 0.45d), new AbilityWeight(PlayerAbility.Stamina, 0.30d), new AbilityWeight(PlayerAbility.PitcherMental, 0.25d) }, 40, 0.015d, 3, 3, -16, 1, canRaisePotential: true)
            };
        }
    }
}
