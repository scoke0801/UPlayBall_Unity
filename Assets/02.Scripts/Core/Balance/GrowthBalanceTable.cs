        ...
        private static TrainingProgramDefinition[] CreateDefaultPrograms()
        {
            return new[]
            {
                ...
                new TrainingProgramDefinition("bat_speed_defense_camp", OffseasonActivityType.PersonalTraining, TrainingCategory.Strength, PlayerType.Batter,
                    4, MoneyAmount.FromTenThousandWon(780L), 1.10d, new[] { new AbilityWeight(PlayerAbility.Speed, 0.45d), new AbilityWeight(PlayerAbility.Defense, 0.45d), new AbilityWeight(PlayerAbility.BatterMental, 0.10d) }, 45, 0.01d, 3, 2, -14, 1),
