...
namespace Baseball.Game.Historical
{
    ...
    public sealed partial class ManagerHistoricalRuntimeState
    {
        ...
        private void ReplaceCurrentRoster(CurrentRosterState roster)
        {
            ...
            if (roster.TeamSeasonKey == PlayerTeamSeasonKey) OwnerSupportService.SynchronizeRoster(this);
            if (roster.TeamSeasonKey == PlayerTeamSeasonKey) OwnerSloganService.SynchronizeRoster(this);
        }
