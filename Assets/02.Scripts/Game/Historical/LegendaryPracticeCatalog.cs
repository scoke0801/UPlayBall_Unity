...
namespace Baseball.Game.Historical
{
    ...
    public sealed class LegendaryPracticeCatalog
    {
        ...
        public static string CreateSimulationVersion(string miniGameJson, string ratingCurveJson) =>
            "practice-v3:" + Baseball.Core.Rules.SimulationVersionStamp.CurrentEngineVersion + ":" +
        ...
        public void Validate(int expectedCount = 100)
        {
            ...
            for (int i = 0; i < teams.Length; i++)
            {
                ...
                if (team == null || team.rank != i + 1 || string.IsNullOrWhiteSpace(team.challengeTeamId) ||
                    !ids.Add(team.challengeTeamId) || string.IsNullOrWhiteSpace(team.teamSeasonKey) ||
        ...
        public static int Compare(LegendaryPracticeTeam a, LegendaryPracticeTeam b)
        {
            int order = b.WinRate.CompareTo(a.WinRate);
