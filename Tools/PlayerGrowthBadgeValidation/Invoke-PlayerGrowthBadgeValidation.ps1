...
$reportRoot = Join-Path $repoRoot 'output/player-growth-badge-validation'
...
$env:BASEBALL_GROWTH_BADGE_CAPTURE = "$reportRoot/screenshots"
...
$arguments = @('-batchmode', '-projectPath', $validationRoot, '-runTests', '-testPlatform', 'EditMode',
    '-testFilter', 'PlayerGrowthBadgeTests;PlayerMiniCardViewTests', '-testResults', "$reportRoot/editmode-results.xml",
