...
$reportRoot = Join-Path $repoRoot 'output/card-back-validation'
...
$env:BASEBALL_CARD_BACK_CAPTURE = "$reportRoot/screenshots"
...
$arguments = @('-batchmode', '-projectPath', $validationRoot, '-runTests', '-testPlatform', 'EditMode',
    '-testFilter', 'OwnerPlayerCardBackTests', '-testResults', "$reportRoot/editmode-results.xml",
