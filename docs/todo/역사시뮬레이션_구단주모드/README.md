...
| 14 | [14_Cost_구종_사전감사.md](../../completed/역사시뮬레이션_구단주모드/14_Cost_구종_사전감사.md) | **완료 기록.** Cost·구종 확장 전 Source/Runtime 계약 감사 |
| 15 | [15_리그_시즌기록_집계.md](../../completed/역사시뮬레이션_구단주모드/15_리그_시즌기록_집계.md) | **완료 기록.** 현재 시즌 개인 기록 집계와 선수 기록 화면 연결 |
| 16 | [16_구단주모드_새게임_스타터로스터_튜토리얼.md](16_구단주모드_새게임_스타터로스터_튜토리얼.md) | 구단·메인 카드·프런트 매니저 선택, 저가치 15장 공개·최대 30회 리롤, 닉네임과 첫 배정 튜토리얼 |
| 17 | [17_프야매_덕아웃_감독_수석코치_역기획.md](17_프야매_덕아웃_감독_수석코치_역기획.md) | 프야매 덕아웃 조사, 감독·수석코치 역할 분리, 결정론적 경기 운영 효과와 실루엣 자산 |
| 18 | [18_프야매_선수성장_역기획_구현배선.md](18_프야매_선수성장_역기획_구현배선.md) | 프야매 선수 성장 조사, 카드 훈련·유학·4×4 스킬 블록·중복 강화의 통합 구현 및 Production 배선 |
| 19 | [선수도감_위시리스트.md](../선수도감_위시리스트.md) | Canonical 전체 선수·카드 탐색, 수집 이력, exact CardId 위시와 Scout 연결 |
