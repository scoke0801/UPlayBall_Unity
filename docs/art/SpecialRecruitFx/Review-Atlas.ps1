...
$atlas=[Drawing.Bitmap]::new((Join-Path $PWD ("Assets/10.Datas/Resources/UI/SpecialRecruitFx/"+$Kind+"Atlas.png")))
...
$review.Save((Join-Path $PWD ("docs/art/SpecialRecruitFx/"+$Kind+"-AlphaReview.png")))
$max=0;$zero=0
